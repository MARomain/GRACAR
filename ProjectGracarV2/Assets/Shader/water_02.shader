    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _normals = lerp(float3((node_5354.rgb.rg*_NormalMap1Strength),node_6022),float3((node_3298.rgb.rg*_NormalMap2Strength),node_6022),_NormalBlendStrength);
