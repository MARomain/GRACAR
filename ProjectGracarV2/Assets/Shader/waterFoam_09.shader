...
////// Emissive:
                float4 node_7601 = tex2D(__CausticNoise,TRANSFORM_TEX(((_normals*0.1+0.0)+float3((i.uv0*0.5),0.0)), __CausticNoise));
