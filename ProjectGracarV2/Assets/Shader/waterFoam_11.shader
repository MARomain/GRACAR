    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_5354 = UnpackNormal(tex2Dlod(_NormalMap,float4(TRANSFORM_TEX(node_7012, _NormalMap),0.0,0)));
                float node_3983 = 1.0;
                ...
                float2 node_83 = _UV2;
                float3 node_3298 = UnpackNormal(tex2Dlod(_NormalMap,float4(TRANSFORM_TEX(node_83, _NormalMap),0.0,0)));
                ...
                float3 node_4724 = _normals;
                v.vertex.xyz += (node_4724*_VertexOffset);
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(lerp(sceneColor.rgb, finalColor,(_Opacity_var.a*_OpacityIntensity)),1);
...
/// Final Color:
                ...
                float4 _Opacity_var = tex2D(_Opacity,TRANSFORM_TEX(i.uv0, _Opacity));
                fixed4 finalRGBA = fixed4(finalColor * (_Opacity_var.a*_OpacityIntensity),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
