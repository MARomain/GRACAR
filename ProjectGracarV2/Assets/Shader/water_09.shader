    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _normals = lerp(node_5354.rgb,node_3298.rgb,_NormalBlendStrength);
